...
AUTHX_SETTINGS = {
    ...
    "OTP_FROM_EMAIL": config("AUTHX_OTP_FROM_EMAIL", default="no-reply@example.com"),
    ...
    "USE_PACKAGE_USER_MODEL": config("AUTHX_USE_PACKAGE_USER_MODEL", default=True, cast=bool),
}
